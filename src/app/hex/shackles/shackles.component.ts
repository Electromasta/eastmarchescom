...
@Component({
  selector: 'app-shackles',
  templateUrl: './shackles.component.html',
  styleUrls: ['./shackles.component.css']
})
export class ShacklesComponent implements OnInit {
  ...
  leafoptions = {
    layers: [
      tileLayer('/assets/leaflets/hexmaps/4_shackles/{z}/{x}/{y}.png', { maxZoom: 18, attribution: '...', tileSize: 1024 })
    ],
    crs:  Util.extend({}, CRS.Simple, {
      transformation: new Transformation(0.000302, 0.000302, 0.000302, 0.000302)
    }),
    zoom: 0,
    minZoom: 0,
    maxZoom: 1,
    center: latLng(1870859, 1768210),
    noWrap: true,
