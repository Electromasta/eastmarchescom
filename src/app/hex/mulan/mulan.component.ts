...
@Component({
  selector: 'app-mulan',
  templateUrl: './mulan.component.html',
  styleUrls: ['./mulan.component.css']
})
export class MulanComponent implements OnInit {
  ...
  leafoptions = {
    layers: [
      tileLayer('/assets/leaflets/hexmaps/5_mulan/{z}/{x}/{y}.png', { maxZoom: 18, attribution: '...', tileSize: 1024 })
    ],
    crs:  Util.extend({}, CRS.Simple, {
      transformation: new Transformation(0.00068982, 0.00068982, 0.00068982, 0.00068982)
    }),
    zoom: 0,
    minZoom: 0,
    maxZoom: 1,
    center: latLng(870000, 870000),
    noWrap: true,
