...
@Component({
  selector: 'app-hool',
  templateUrl: './hool.component.html',
  styleUrls: ['./hool.component.css']
})
export class HoolComponent implements OnInit {
  ...
  leafoptions = {
    layers: [
      tileLayer('/assets/leaflets/hexmaps/2_hool/{z}/{x}/{y}.png', { maxZoom: 18, attribution: '...', tileSize: 1024 })
    ],
    crs:  Util.extend({}, CRS.Simple, {
      transformation: new Transformation(0.00051, 0.00051, 0.00051, 0.00051)
    }),
    zoom: 0,
    minZoom: 0,
    maxZoom: 1,
